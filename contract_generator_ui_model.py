...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.period_checkbox = QCheckBox(self.scrollAreaWidgetContents)
        self.period_checkbox.setObjectName(u"period_checkbox")
        self.period_checkbox.setEnabled(False)
        self.period_checkbox.setLayoutDirection(Qt.RightToLeft)

        self.horizontalLayout_5.addWidget(self.period_checkbox)
        ...
        self.horizontalLayout_5.addWidget(self.period_label)


        self.gridLayout_3.addLayout(self.horizontalLayout_5, 17, 0, 1, 1)
        ...
        QWidget.setTabOrder(self.lang_selector, self.contract_template_selector)
        QWidget.setTabOrder(self.contract_template_selector, self.party_a_name_selector)
        QWidget.setTabOrder(self.party_a_name_selector, self.party_a_representative_selector)
        QWidget.setTabOrder(self.party_a_representative_selector, self.party_a_registered_address_edit)
        QWidget.setTabOrder(self.party_a_registered_address_edit, self.party_a_contact_address_edit)
        QWidget.setTabOrder(self.party_a_contact_address_edit, self.party_b_name_edit)
        QWidget.setTabOrder(self.party_b_name_edit, self.party_b_representative_edit)
        QWidget.setTabOrder(self.party_b_representative_edit, self.party_b_registered_address_edit)
        QWidget.setTabOrder(self.party_b_registered_address_edit, self.party_b_contact_address_edit)
        QWidget.setTabOrder(self.party_b_contact_address_edit, self.start_date_selector)
        QWidget.setTabOrder(self.start_date_selector, self.period_checkbox)
        QWidget.setTabOrder(self.period_checkbox, self.period_years_selector)
        QWidget.setTabOrder(self.period_years_selector, self.period_months_selector)
        QWidget.setTabOrder(self.period_months_selector, self.end_date_selector)
        QWidget.setTabOrder(self.end_date_selector, self.signature_date_selector)
        QWidget.setTabOrder(self.signature_date_selector, self.payment_method_selector)
        QWidget.setTabOrder(self.payment_method_selector, self.currency_selector)
        QWidget.setTabOrder(self.currency_selector, self.cross_border_payment_yes)
        QWidget.setTabOrder(self.cross_border_payment_yes, self.cross_border_payment_no)
        QWidget.setTabOrder(self.cross_border_payment_no, self.bank_account_edit)
        QWidget.setTabOrder(self.bank_account_edit, self.account_name_edit)
        QWidget.setTabOrder(self.account_name_edit, self.name_of_the_bank_edit)
        QWidget.setTabOrder(self.name_of_the_bank_edit, self.bank_code_edit)
        QWidget.setTabOrder(self.bank_code_edit, self.name_of_the_branch_edit)
        QWidget.setTabOrder(self.name_of_the_branch_edit, self.branch_code_edit)
        QWidget.setTabOrder(self.branch_code_edit, self.swift_code_edit)
        QWidget.setTabOrder(self.swift_code_edit, self.country_of_the_bank_receiving_the_payment_edit)
        QWidget.setTabOrder(self.country_of_the_bank_receiving_the_payment_edit, self.other_code_cnaps)
        QWidget.setTabOrder(self.other_code_cnaps, self.other_code_skn_code)
        QWidget.setTabOrder(self.other_code_skn_code, self.other_code_bsb_number)
        QWidget.setTabOrder(self.other_code_bsb_number, self.other_code_iban_code)
        QWidget.setTabOrder(self.other_code_iban_code, self.other_code_edit)
        QWidget.setTabOrder(self.other_code_edit, self.generate_button)
        QWidget.setTabOrder(self.generate_button, self.scrollArea)
        ...
        self.period_checkbox.clicked.connect(MainWindow.on_period_checkbox_clicked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.period_years_selector.setCurrentText(QCoreApplication.translate("MainWindow", u"1", None))
